...
const Navbar = () => {
  ...
  return (
    <nav className=" bg-dark text-white navbar navbar-expand-lg navbar-light bg-light py-3 sticky-top">
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="buttons text-center">
            ...
            <NavLink to="/cart" className="btn btn-outline-dark m-2 text-white">
